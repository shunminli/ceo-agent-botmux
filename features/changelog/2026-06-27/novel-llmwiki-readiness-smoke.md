...
- Runs `llmwiki reindex` through the configured executable.
- Confirms copied wiki pages and `.llmwiki/index.db` exist.

This closes the local write/reindex verification gap without touching real project files or bypassing production humanGate rules.
